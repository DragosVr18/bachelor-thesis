...
# Modifications: Added ability to skip loading backbone and HPH head (for later initialization in derivated classes)
...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        self.num_bands = camera_embedding_num_bands
        self.max_resolution = camera_embedding_max_resolution
